...
function systemPrompt({ samples = [], maxChars = DEFAULT_MAX_CHARS, mode = 'spontaneous', name = 'Стас', avoid = [] }) {
  ...
  return [
    ...
    '— не повторяй шутку или оборот, которые уже звучали в этом разговоре, даже если',
    '  их подхватили другие: разговор, где одна фраза крутится по кругу, выдаёт машину;',

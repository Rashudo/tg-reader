...
test('приветствия новичкам не приходят ни по одной группе', () => {
  const bikes = 'Sofi, добро пожаловать в группу Нови Сад Велосипеды/Барахолка.\n\n📌 Лень разбираться в Excel? Для вас уже всё сделали. @hacks_excel';
